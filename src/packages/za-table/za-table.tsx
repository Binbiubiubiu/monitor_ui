...
export type ZaTableState = {
  /** 缓存获取到的变量 */
  list: any[];
  count: number;
};

export class ZaTable extends Component<ZaTableProps, ZaTableState> {
  static defaultProps = defaultProps;

  constructor(props: ZaTableProps) {
    super(props);
    this.state = {
      count: 11,
  ...
  _renderLoading() {
    return (
      <div className="za-table__loading">
        <ZaLoading className="loading-icon" /> 加载中...
      </div>
    );
  }
