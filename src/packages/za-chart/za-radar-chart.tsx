...
export interface ZaRadarChartProps {
  /**
   * 数据
   */
  data: any[];
...
export class ZaRadarChart extends Component<ZaRadarChartProps> {
  chartRef: React.RefObject<HTMLDivElement>;
  chart?: ECharts;

  constructor(props: ZaRadarChartProps) {
    super(props);
