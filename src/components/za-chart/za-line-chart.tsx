...
export interface ZaLineChartProps {
  /**
   * x轴
   */
  xAxis: any[];
...
export class ZaLineChart extends Component<ZaLineChartProps> {
  chartRef: React.RefObject<HTMLDivElement>;
  chart?: ECharts;

  constructor(props: ZaLineChartProps) {
    super(props);
